...
int main(void) {
    ...
    switch (chosen_action) {
        ...
        fprintf(myfile, "<polygon fill='green' points='335,575 665,575 701,650 549,650 500,626 451,650 299,650'/>\n");
        ...
        fprintf(myfile, "<ellipse cx='500' cy='560' rx='4' ry='8' fill='none' stroke='black'/>\n");
        fprintf(myfile, "<ellipse cx='500' cy='563' rx='2' ry='4' fill='none' stroke='black'/>\n");
         break;
        }
        case 3: {
